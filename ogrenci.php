...
<table width="557" border="1">
  ...
  <tr>
    <td><center><h3>Şifreyi Tekrar Giriniz:</h3></center></td>
    <td><center><input type="password" name="sifre1" id="sifre1" align="right"  class="txt" required/></center></td>
  </tr>
</table>
<p>&nbsp;</p>
  <p>&nbsp;</p>
 <center><h3><button type="submit" id="button" class="btn">Öğrenci Ekle</button></h3></center>
 </center>
</form>  
<!--- container div end -->
