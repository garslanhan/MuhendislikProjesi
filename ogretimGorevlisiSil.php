<?php 
	...
	if ( !empty($_POST)) {
		...
		$sql = "DELETE FROM ogretimgorevlisi  WHERE ogretimGorevlisiId = ?";
		$q = $pdo->prepare($sql);
		$q->execute(array($id));
		Database::disconnect();
...
<center>
<h3>ÖĞRETİM GÖREVLİSİ SİLME İŞLEMLERİ</h3></center>
</div>
...
<div class="logo-wrapper">
  <div class="logo">
  &nbsp;&nbsp;
<a href="ogrenciGorevlisiKayit.php">Kayıtları Gör</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<form class="form-horizontal" action="ogretimGorevlisiSil.php" method="post"><center>
                    ...
                    <center> <button type="submit" class="btn"><a href="ogretimGorevlisiKayit.php"><h3>Hayır</h3></a></button></center>
