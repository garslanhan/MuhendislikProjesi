...
<div class="container">
  <div class="panel-wrapper">
    ...
    <div class="title">
      ...
      <div class="content">
   <table width="695"  >
    <td width="687" height="95"><table width="670"  >
      ...
      <tbody>
		              <?php 
					   ...
					   $sql="SELECT randevu.randevuId,randevu.randevuAciklamasi,randevu.randevuSaati,randevu.randevuTarihi,ogrenciNo,ogrenciAd,ogrenciSoyad FROM randevu INNER JOIN ogrenci ON ogrenci.ogrenciId=randevu.kullaniciid  INNER JOIN ogretimgorevlisi ON ogretimgorevlisi.ogretimGorevlisiId=randevu.ogretimGorevlisiId where ogretimGorevlisi.ogretimGorevlisiId='".$kullaniciid."'";
